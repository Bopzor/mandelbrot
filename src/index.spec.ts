...
// import { Color, getColorFromProgression, normalize, toComponent } from './index';
...
//     expect(getColorFromProgression(0, palette)).to.eql([0, 0, 0]);
//     expect(getColorFromProgression(0.25, palette)).to.eql([0, 128, 0]);
//     expect(getColorFromProgression(0.5, palette)).to.eql([0, 255, 0]);
//     expect(getColorFromProgression(1, palette)).to.eql([0, 0, 255]);
//   });
// });
